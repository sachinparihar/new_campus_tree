...
/*
    ...
    //       //upload it on cloud
    // //       const js="djjsjsnnnnjjs";
    // //        const re = cloudinary.uploader.upload(req.body.image, {public_id: js})
    
    // // re.then((data) => {
    // //   console.log(data);
    // //   console.log(data.secure_url);
    // //   const i={  public_id:js,
    // //     url:data.secure_url};
    ...
    // // await images.save();
    // //const images=image.findOne({_id:'63f22b79e8c0f65ed755d780'});
    // await image.findOneAndUpdate({name:"pra"},{
    //    $push:{image:{
    //      url:"jjkkks",
    //      typee:"jjjjj",
    ...
    //  //const images=await imageModel.findOne({name:"pra"});
    // //  const data={url:"iia",type:"jjsjjs"};
    // //  const images=await imageModel.find({name:"pra"});
